...
(custom-theme-set-faces
 ...
 '(italic ((t (:italic t))))
 '(modeline ((t (:background "DarkSeaGreen4" :foreground "AntiqueWhite"))))
 '(modeline-buffer-id ((t (:background "DarkSeaGreen4" :foreground "DarkBlue"))))
 '(modeline-mousable ((t (:background "DarkSeaGreen4" :foreground "firebrick"))))
 '(modeline-mousable-minor-mode ((t (:background "DarkSeaGreen4" :foreground "wheat"))))
