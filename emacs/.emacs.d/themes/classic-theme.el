...
;; Version: 0.02
;; tweaked by Matt Thompson <chameleonator@gmail.com>
...
(custom-theme-set-faces
 ...
 '(view-highlight-face ((t (:background "#3f5f5f" :foreground "DarkGreen"))))
 ...
 '(italic ((t (:italic t))))
 '(modeline ((t (:background "LightDarkSeaGreen4" :foreground "AntiqueWhite"))))
 '(modeline-buffer-id ((t (:background "LightDarkSeaGreen4" :foreground "DarkBlue"))))
 '(modeline-mousable ((t (:background "LightDarkSeaGreen4" :foreground "firebrick"))))
 '(modeline-mousable-minor-mode ((t (:background "LightDarkSeaGreen4" :foreground "wheat"))))
